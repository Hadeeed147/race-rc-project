...
const AccordionItem = forwardRef(({ className, ...props }, ref) => (
  <AccordionPrimitive.Item
    ref={ref}
    className={cn('border border-border rounded-xl bg-card overflow-hidden mb-3', className)}
    {...props}
  />
))
  ...
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ...
      className={cn(
        ...
        'hover:bg-secondary/50 transition-colors [&[data-state=open]>svg]:rotate-180',
        className
      )}
      {...props}
    >
